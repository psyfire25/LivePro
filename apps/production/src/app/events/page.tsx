      ...
      <Tabs defaultValue="list" className="ui:bg-transparent">
        ...
        <TabsContent value="create" className="ui:mt-4">
          <form onSubmit={submit} className="ui:grid ui:grid-cols-1 md:ui:grid-cols-5 ui:gap-3 ui:items-end">
            ...
            <select
              className="ui:h-9 ui:rounded-md ui:border ui:bg-[var(--lp-card-bg)] ui:px-3 ui:text-sm ui:text-[var(--lp-fg)]"
        ...
        <TabsContent value="list" className="ui:mt-4">
          <table className="ui:w-full ui:text-left ui:border ui:rounded-md ui:overflow-hidden" style={{ borderColor: 'var(--lp-border)' }}>
            <thead>
              <tr className="ui:bg-black/5 dark:ui:bg-white/5"><th className="ui:p-2">Name</th><th className="ui:p-2">Type</th><th className="ui:p-2">Start</th><th className="ui:p-2">End</th></tr>
            </thead>
            <tbody>
              {events.map(ev => (
                <tr key={ev.id} className="ui:border-t hover:ui:bg-black/5 dark:hover:ui:bg-white/5" style={{ borderColor: 'var(--lp-border)' }}>
